...
This folder contains app-specific notes, settings references, and other documentation.
...
This folder stores app information that does not fit naturally under `configs/`.
